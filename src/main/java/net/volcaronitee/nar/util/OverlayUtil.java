...
public class OverlayUtil {
    private static final Identifier LAYER = Identifier.of(NotARat.MOD_ID, "overlays");
    ...
    private static class OverlayScreen extends Screen {
        /**
         * Creates a new OverlayScreen instance with the title set to the current NAR version.
         */
        public OverlayScreen() {
            super(Text.literal("Overlay Management - NAR " + NotARat.MOD_VERSION));
        }
